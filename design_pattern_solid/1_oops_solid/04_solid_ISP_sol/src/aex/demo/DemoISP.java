...
import com.busycoder.persistance.OrderRepoImpl;
import com.busycoder.persistance.Repository;
import com.busycoder.persistance.UserRepoImpl;
...
//		Repository<User> repo=new UserRepo();
//		repo.findByName("raj");
		
		Repository<Order> repo=new OrderRepoImpl();
		repo.findById(2L);
